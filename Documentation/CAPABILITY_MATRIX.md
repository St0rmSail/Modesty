...
**Baseline:** Build 0.38.0 complete; Build 0.19 acceptance paused
**Reviewed:** 2026-09-06
...
| Fishing Buddy | Yes | Yes | Partial | Level 2 demonstrated through Build 0.36: a live RF4-only weakest-rank catalogue of 251 species plus concise source-labelled natural retrieval with safe approximate matching and truthful unknowns. The Angler inspector is parked; no personal game-state adapter or automatic catch tracking yet |
...
| Background service presence | Yes | Yes | Yes | Build 0.38 live accepted: close/command hide retains the local process and heartbeat, tray restores the same session, and Bye/tray Quit shut down cleanly; scheduled duties, remote clients, and orchestration remain future work |
