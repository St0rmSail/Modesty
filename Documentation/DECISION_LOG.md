...
| D-055 | The first Librarian repair accepts one named UTF-8 Markdown or plain-text Intake file up to 2 MiB, preserves the original, writes one hashed provisional Workbench derivative, logs every mechanical change and caution, re-checks hashes at approval, and uses local Keep Repair or Toss Repair disposition. It may not guess paragraph joins, hyphenation, missing text, or meaning-changing corrections. | Canonical Build 0.21 boundary |
| D-056 | Exact commands, hashes, and job IDs are internal safety and audit mechanisms, not the required everyday Librarian interface. Routine work must accept bounded contextual language and visible choices; escalating command memorization is a functional accessibility defect that must be corrected before further Librarian capability or visual polish. | Canonical interaction rule |
| D-057 | The Researcher is deliberately parked at demonstrated Level 3 with Build 0.19 preserved but still awaiting live mixed-source acceptance; the Librarian is deliberately parked at demonstrated Level 2 through Build 0.33. Neither portfolio blocks other Team work. | Canonical project priority |
| D-058 | The Fishing Buddy is a distinct unseen Team specialist. She owns fishing-specific trip preparation, condition interpretation, tackle and bait guidance, and confirmed post-trip learning; Modesty remains the sole speaker. Current weather, regulations, access, and water conditions require identified evidence, and purchases, bookings, permits, messaging, and medical judgement remain outside her authority. | Canonical Team boundary |
| D-059 | The Fishing Buddy's primary office is an external fishing-simulator companion for RF4, Fisher Online, Professional Fishing 2, and Call of the Wild: The Angler. Each game has a separate private local codex. Automatic progress and catch tracking require a verified permitted read-only interface; save writes, injection, packet interception, anti-cheat evasion, prohibited scraping, and silent account action are forbidden. | Canonical simulator boundary |
| D-060 | Fishing presentation mode visually remains Modesty: lure-covered baseball cap, large rod, tackle box, and an outdoor lakeside Study with her standing on a rock in the shallows. The Fishing Buddy remains unseen and earns a separate Bobblehead only through demonstrated duty. The visual mode cannot mutate accepted neutral Study geometry. | Canonical visual direction |
