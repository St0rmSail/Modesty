...
| Background presence host | `Runtime/Time/background.py`, `Runtime/study.py` | Windows tray-hosted hide/restore and clean explicit shutdown implemented and demonstrated |
